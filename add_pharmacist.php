...
<?php
    if(isset($_POST['submit'])){
        ...
        $res = mysqli_query($con,"Insert into pharmacist (first_name,last_name,staff_id,postal_address,phone,email,username,password) values('$first_name','$last_name','$staff_id','$postal_address','$phone','$email','$username', '$password')");
        if($res){
